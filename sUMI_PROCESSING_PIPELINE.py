...
###########################
if(len(sys.argv)<10):
  print "\nUsage:\npython Read_processing_and_quality_PUBLIC.py <input directory> <sample ID> <sample ID of pooled library> <source files> <thresold length> <sUMI primer file> <sUMI_sample barcode id> <sample barcode file> <cd-hit location>"
  quit()
