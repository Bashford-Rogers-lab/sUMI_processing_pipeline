...
# at the University of Oxford and University of Cambridge
# E-mail: rbr1@well.ox.ac.uk

# If you find the methods in sUMI_PROCESSING_PIPELINE, please cite the following reference:
# Ahmed, R. et al. 2020 (Ultrasensitive amplicon barcoding for next-generation sequencing
# facilitating sequence error and amplification-bias correction)
...
###########################
if(len(sys.argv)<8):
  print "\nUsage:\npython sUMI_PROCESSING_PIPELINE.py <input directory> <sample ID> <sample ID of pooled library> <sUMI primer file> <sUMI_sample barcode id> <sample barcode file> <cd-hit location>"
  quit()
